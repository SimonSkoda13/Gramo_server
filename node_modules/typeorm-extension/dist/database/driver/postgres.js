        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    existQuery = "SELECT * FROM pg_database WHERE lower(datname) = lower('" + connectionOptions.database + "');";
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    query = "CREATE DATABASE \"" + connectionOptions.database + "\"";
                    if (typeof customOptions.characterSet === 'string') {
                        query += " WITH ENCODING '" + customOptions.characterSet + "'";
                    }
                    return [4 /*yield*/, executeSimplePostgresQuery(connection, query)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    query = customOptions.ifExist ? "DROP DATABASE IF EXISTS \"" + connectionOptions.database + "\"" : "DROP DATABASE \"" + connectionOptions.database + "\"";
                    return [4 /*yield*/, executeSimplePostgresQuery(connection, query)];
