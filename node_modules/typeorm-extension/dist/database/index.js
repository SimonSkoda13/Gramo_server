        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    simpleConnectionOptions = (0, utils_1.buildSimpleConnectionOptions)(connectionOptions);
                    ...
                    return [4 /*yield*/, (0, sqlite_1.createSQLiteDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 3: return [2 /*return*/, _a.sent()];
                case 4: return [4 /*yield*/, (0, sqlite_1.dropSQLiteDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 5: return [2 /*return*/, _a.sent()];
                case 6:
                    if (!(driver instanceof MysqlDriver_1.MysqlDriver)) return [3 /*break*/, 10];
                    if (!isCreateOperation) return [3 /*break*/, 8];
                    return [4 /*yield*/, (0, mysql_1.createMySQLDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 7: return [2 /*return*/, _a.sent()];
                case 8: return [4 /*yield*/, (0, mysql_1.dropMySQLDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 9: return [2 /*return*/, _a.sent()];
                case 10:
                    if (!(driver instanceof PostgresDriver_1.PostgresDriver)) return [3 /*break*/, 14];
                    if (!isCreateOperation) return [3 /*break*/, 12];
                    return [4 /*yield*/, (0, postgres_1.createPostgresDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 11: return [2 /*return*/, _a.sent()];
                case 12: return [4 /*yield*/, (0, postgres_1.dropPostgresDatabase)(driver, simpleConnectionOptions, customOptions)];
                ...
                case 14:
                    ...
                    return [4 /*yield*/, (0, cockroachdb_1.createCockroachDBDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 15: return [2 /*return*/, _a.sent()];
                case 16: return [4 /*yield*/, (0, cockroachdb_1.dropCockroachDBDatabase)(driver, simpleConnectionOptions, customOptions)];
                ...
                case 18:
                    ...
                    return [4 /*yield*/, (0, oracle_1.createOracleDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 19: return [2 /*return*/, _a.sent()];
                case 20: return [4 /*yield*/, (0, oracle_1.dropOracleDatabase)(driver, simpleConnectionOptions, customOptions)];
                ...
                case 22:
                    ...
                    return [4 /*yield*/, (0, mssql_1.createMsSQLDatabase)(driver, simpleConnectionOptions, customOptions)];
                case 23: return [2 /*return*/, _a.sent()];
                case 24: return [4 /*yield*/, (0, mssql_1.dropMsSQLDatabase)(driver, simpleConnectionOptions, customOptions)];
